...
//        Log.d(LOG_TAG, "[test source being requested] TestTelephony signal strength change " );
        ...
        try{
            ...
            //call state
            UsageService.setCallState(tm.getCallState());
...
//                    " network operator " + PhoneStatusManager.getNetworkOperatorName() + " phonetype " + PhoneStatusManager.getPhoneTypeName());
            ...
            UsageService.setGSM(signalStrength.isGsm());
            ...
            if ( tm.getNetworkType() == TelephonyManager.NETWORK_TYPE_LTE){
                ...
                UsageService.setLTESignalStrength(dbm);
                UsageService.setGeneralSignalStrength(dbm);
...
//                Log.d(LOG_TAG, "[test source being requested] TestTelephony LTE strength: " + PhoneStatusManager.getLTESignalStrength());
                ...
                if (signalStrength.getGsmSignalStrength() != 99) {
                    ...
                    UsageService.setGsmSignalStrength(dbm);
                    UsageService.setGeneralSignalStrength(dbm);
...
//                   Log.d(LOG_TAG, "[test source being requested] TestTelephony GSM strength: " + PhoneStatusManager.getGsmSignalStrength() + "asu: " + signalStrength.getGsmSignalStrength());
                    ...
                    UsageService.setGsmSignalStrength(signalStrength.getGsmSignalStrength());
                    UsageService.setGeneralSignalStrength(signalStrength.getGsmSignalStrength());
                }
            ...
            /** if not GSM...: CDMA **/
                ...
                if (snr == -1) { //if not 3G, use cdmaDBM or cdmaEcio
                    ...
                    UsageService.setCdmaSignalStrenthLevel(_CdmaSignalStrenthLevel);
